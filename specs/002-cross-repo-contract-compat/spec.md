...
- Recorded answers on 2026-09-06: Q1 = regenerate the consumer declaration from verified producer evidence; Q2 = new standalone change, do not edit the open README-accuracy change. Clarify completed the same day with no remaining critical ambiguities. Plan-time named producer revision is `536c79e`; implement must re-verify `origin/main` before emitting.
