"""Provider-neutral receipts for deterministic risk evaluation."""
...
def build_risk_receipt(
    *,
    ...
    """Return a deterministic, informational risk-provider receipt."""
...
__all__ = ["SCHEMA_VERSION", "build_risk_receipt"]
